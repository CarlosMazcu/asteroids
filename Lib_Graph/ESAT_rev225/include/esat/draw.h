...
namespace esat {
  ...
  void DrawSetStrokeColor(//para colorear la linea que pintemos
      unsigned char R,
      unsigned char G, 
      unsigned char B,
  ...
  void DrawLine(float x1,float y1,float x2,float y2);//funcin que pinta una linea a la cual hay que pasarle dos coordenadas
